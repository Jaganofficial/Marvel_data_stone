...
fun ShowData(
    ...
    Column(
            ...
            Box()
            {
                ...
                )
                {
                    ...
                    Card(modifier = Modifier
                        ...
                        .clickable { navController.navigate(MarvelDataScreens.SearchScreen.name) },
        ...
        if (mainViewModel.comicsList.collectAsState().value.isNotEmpty()) {
            ...
            if (comicsData.loading == true)
                ...
                if (comicsData.e == null) {
                    ...
                    {
                        Text(
                            text = "Oops! Something went wrong! Please check your internet connectivity",
                            textAlign = TextAlign.Center,
                            color = MaterialTheme.colors.primaryVariant
                        )
                    }
